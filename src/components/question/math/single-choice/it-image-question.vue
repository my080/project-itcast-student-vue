<template>
	<div class="it-math-single-choice-I-I">
		<it-stem :question="questionData" :index="qIndex"
		         @submit="submit" @finish="finish"></it-stem>
...
<script>
	import Stem from './components/it-image-stem.vue'
	import Footer from './components/it-footer.vue'

	export default {
		name: 'it-math-single-choice-I-II',
		components: {
			'it-stem': Stem,
			'it-footer': Footer
		},
		...
		methods: {
			...
			submit (data) {
				...
				console.log(this.isInProgress, this.status)
